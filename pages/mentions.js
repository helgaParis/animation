...
export default function Mentions() {
    return (
        ...
        <h4><a href={`mailto:${email}?subject=Page Mentions du Conseil du Quartier JM PO&body= `}>Email : conseil14@asf-web.fr</a></h4>
        <h4>Site web : </h4>
        <p><Link href="/">
        ...
        <a href="https://github.com/helgaParis/animation"  rel="noopener" target="_blank" >https://github.com/helgaParis/animation</a><br/></p>
        ...
        <p>En application du Code français de la propriété intellectuelle, il est interdit pour un usage autre que privé ou pédagogique de reproduire, vendre, diffuser, modifier, publier intégralement ou partiellement, sous quelque forme que ce soit les données, la présentation ou l'organisation du site ainsi que les œuvres protégées par les droits d’auteur qui y figurent, sans autorisation écrite préalable, dont la demande doit être adressée au webmaster.</p>
          ...
          <ul>
            ...
            <li>envoyer les communications relatives aux actualités du conseil de quartier (invitations aux réunions, lettre d’information, annonces d’évènements organisés par le conseil de quartier…)</li>
              <li>réaliser des statistiques sur la fréquentation et l’utilisation de notre site internet</li>            
            </ul>
            <h4>Objectif du traitement par type de données traitées</h4>
            <ul>
            <li>Demande d’information - Données d’identification: état-civil (si ce dernier est communiqué par le visiteur), adresse e-mail</li>
            <li>Communication relatives au conseil de quartier - Données d’identification : adresse e-mail</li>
            <li>Réalisation de statistiques - nous ne collectons pas de données personalisées à ce stade du projet. </li>
            </ul>
            ...
            <a href={`mailto:${email}?subject=Données enregistrées par le Conseil du Quartier JM PO&body=Mes données `}>Email : conseil14@asf-web.fr</a></p>
