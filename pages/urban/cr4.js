...
export default function Cr4() {
    return (
        <Layout >
        <Head>
          <title> Conseil de quartier JMPO – Commission urbanisme - Compte Rendu 4</title>
        </Head>
        <main className={styles.main}>
        <Nav1urban></Nav1urban>
        <h1 className={styles.title}>Compte rendu de la réunion du 14 mai 2019</h1>
        <p>Présents : Jean-Philippe, Chantal, Paul, Claire, Annie, Rachida, Hélène, Eric<br/>
        Excusés : Antonella, Benjamin</p>
        ...
        <h2>City stade rue de Châtillon</h2>
        <p>RV avec la maire le 21 mai </p>
        <h2>Projet 100 Bd Jourdan</h2>
        ...
        <h2>Aménagement de l’av. Gal Leclerc</h2>
        ...
        <h2>Fresque rue du Père Corentin</h2>
        ...
        <h2>Fonctionnement de notre commission</h2>
