...
export default function Cr3() {
    return (
        <Layout >
        <Head>
          <title> Conseil de quartier JMPO – Commission urbanisme - Compte Rendu 3</title>
        </Head>
        <main className={styles.main}>
            ...
            <h2>50 Bd Jourdan (ex-garage Citroën)</h2>
            ...
            <h2>Aménagement av. Gal Leclerc</h2>
            ...
            <h2>Aménagement de la place des Droits de l’enfant</h2>
            ...
            <h2>Une rue pour les enfants</h2>
            ...
            <h2>Réflexion sur la Porte d’Orléans</h2>
