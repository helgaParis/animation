...
export default function Blog() {
    return (
        ...
        <p>Une véritable inauguration est attendue pour la rentrée, mais d’ores et déjà la commission souhaite être fixée sur le projet d’aménagement du sous-sol qui ne semble plus être d’actualité (activités de loisirs/sportives annoncées en réunion publique) => interpellation mairie (Eric)</p>
        
        <h3>Projet immobilier au 100 Jourdan</h3>
        <p>La commission s’est impliquée sur ce projet, et a adressé une lettre à la maire du 14ième pour attirer son attention sur la volumétrie de l’immeuble envisagé et sur la largeur insuffisante du trottoir. Elle souhaiterait connaitre les motifs du rejet du permis de construire => interpellation mairie (Eric)</p>
        ...
        <ul>
            ...
            <li>Enlèvement d’une colonne Morris Bd Brune signalée par une habitante, sans aucune information préalable. Propriété de la société Decaux, 550 colonnes seraient ainsi remplacées à Paris par du mobilier lumineux et pivotant => à confirmer par la mairie du 14ième (Eric)</li>
