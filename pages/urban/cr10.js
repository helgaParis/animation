...
export default function Cr10() {
    return (
        <Layout >
        <Head>
          <title> Conseil de quartier JMPO – Commission urbanisme - Compte Rendu 10</title>
        </Head>
        <main className={styles.main}>
            ...
            <h2>Aménagements temporaires suite Covid</h2>
            ...
            <h2>Aménagement de la place VB</h2>
            ...
            <h2>Nuisances causées par les bus</h2>
           ...
           <h2>Parcs stationnement vélos</h2>
           ...
           <h2>Projet d’aménagement de la place des Droits de l’Enfant</h2>
