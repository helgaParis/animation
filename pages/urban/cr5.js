...
export default function Cr5() {
    return (
        <Layout >
        <Head>
          <title> Conseil de quartier JMPO – Commission urbanisme - Compte Rendu 5</title>
        </Head>
        ...
        <h2>Aménagement de l’avenue du Gal Leclerc</h2>
        ...
        <h2>Centre d’hébergement 50 Jourdan</h2>
        ...
        <h2>Projet immobilier au 100 Jourdan</h2>
