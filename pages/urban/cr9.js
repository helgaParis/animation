...
export default function Cr9() {
    return (
        <Layout >
        <Head>
          <title> Conseil de quartier JMPO – Commission urbanisme - Compte Rendu 9</title>
        </Head>
        <main className={styles.main}>
            ...
            <p>Présents :<br/>
            APUR : Paul Baroin, directeur d’études<br/>
            Mairie 14 : Jérôme Perrot, Chargé urbanisme cabinet de la maire<br/>
            CommUrba : Clément, Claire, Annie, Marion, Antonella, Eric</p>
            <h2>Le contexte de l’étude par Paul Baroin</h2>
            <ul>
            ...
            <h2>Compléments apportés par Jérôme Perrot (après le départ de Paul Baroin)</h2>
            <ul>
