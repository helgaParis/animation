...
export default function Cra7() {
    return (
        <Layout >
        <Head>
          <title>Comité d'Animation  - Comitée d'animation, conseil de quartier JMPO - Compte Rendu 7</title>
        </Head>
        <main className={styles.main}>
            <Nav1anim></Nav1anim>
            <h1 className={styles.title}>Comité d’animation, réunion  du 22 09 2020</h1>
            <p>à la Maison des réfugiés<br/>
           Présents : 7 conseillers </p>
            ...
            <h2>Principes retenus pour le déroulement</h2>
            <ul>
            ...
            <h2>Ordre du jour</h2>
             ...
             <li> Commission Communication : présentation du projet de site internet</li>
              ...
              <h2>Demande budgétaire par la commission Poinçon</h2>
              ...
              <h2>Projet de budget annuel des Rendez-vous de la Petite Gare 2020-2021</h2>
