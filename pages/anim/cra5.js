...
export default function Cra5() {
    return (
        <Layout >
        <Head>
          <title>Comité d'Animation - Comitée d'animation, conseil de quartier JMPO - Compte Rendu 5</title>
        </Head>
        <main className={styles.main}>
            ...
            <h2>Aide aux personnes vulnérables</h2>
            ...
            <h2>Projet forum des associations sur l’environnement</h2>
